...
This file contains domain-independent verification tests for 1D numerical methods.
The tests verify accuracy across:
  - Different domain sizes and locations
  - Different manufactured solutions (trig, polynomial, exponential)
  - Different resolutions

These tests can be applied to ANY 1D numerical solver by passing it to SimpleMMSTest.
"""
...
println("="^70)
println("1D Verification Test Suite: Poisson Equation")
println("="^70)
println()

@testset "1D Poisson Verification Tests" begin
...
println()
println("Summary:")
println("  - 9 comprehensive verification tests")
...
println("  - Solver verified against manufactured solutions ✓")
println()
println("These tests are domain/PDE-independent and can verify ANY 1D solver")
println("by simply changing the solver function passed to SimpleMMSTest.")
println()
